...
aa[['Close']].plot(ax=ax1, legend=False, color="white", linewidth=4)
...
sizz = 20
ax1.text(xHh, (highL+7), (str('High: ')+str(HighV)), bbox=dict(boxstyle = "square",facecolor = "#00FF00", edgecolor='#154734'), fontsize=sizz, fontweight="bold", color ="k")
ax1.text(xLl, (LowL-9), (str('Low: ')+str(LowV)), bbox=dict(boxstyle = "square",facecolor = "#FF0000", edgecolor='#800500'), fontsize=sizz, fontweight="bold")
ax1.text(open_min_10, (OlPP+0), (str('Open: ')+str(OpenV)), bbox=dict(boxstyle = "square",facecolor = "#FFFF00", edgecolor='#FF6600'), fontsize=sizz, fontweight="bold",horizontalalignment = "right", color ="k")
ax1.text(close_plus_10, (ClPP+0), (str('Close: ')+str(CloseV)), bbox=dict(boxstyle = "square",facecolor = "#CC00FF", edgecolor='#FF00FF'), fontsize=sizz, fontweight="bold",horizontalalignment = "left")
ax1.text(open_min_10, (previousClose - 3), (str('Prev.Close: ')+str(PrevCloseV)), bbox=dict(boxstyle = "square",facecolor = "#D7D2CB", edgecolor='#393D47'), fontsize=sizz, fontweight="bold",horizontalalignment = "right", color ="k")
...
'''
Titls = str("Nifty 50: ") + str(today) + str(" | ") + str (CloseV) + str(" ( ")  + str (TotalDel) + str(" ) ")  + str(" ( ")  + str (Percen) + str(" %) ")
