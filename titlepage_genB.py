...
Image1 = Image.open('PlainBackground2.png').convert('RGBA')
...
image2 = Image.open('Verticaleside1B.png').convert('RGBA')
...
draw2.text((40, 5), text=text, font=font, fill= '#4d0026')
...
draw2 = ImageDraw.Draw(image3)
draw2.text((5, 5), text=text, font=font, fill= '#4d0026')
